...
| 5 | **诊断 run 与 campaign 表之间没有闸门** | → `work/active/diagnostic-run-gate.md`（正文与两个候选做法都在那边） | 中 |
| 6 | **`--headless` 已弃用而本仓仍在用** | → `work/active/headless-flag-deprecation.md`（正文、落点三分与关闭条件都在那边） | 低 |
