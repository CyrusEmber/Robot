...
| 姿态与承重（诊断器实测） | 躯干前倾 26.2–26.7°；`neck_pitch` 承重 82–94 N = **体重 47–49%**；其碰撞网格最低世界 z **−0.052…−0.054 m**（入地 5 cm） | 头颈撑地 |
...
非足承重（≥10% 体重持续 ≥0.5 s）、非足碰撞网格最低 z > 0；脚 duty / 脚载荷份额 / `feet_down` 作诊断。
