...
next: ① 按正文「评测协议交付」确定产品口径、补标定样本并发布新协议；采集/指标/报告检查/固定命令机制只消费 work/active/baseline-eval-pipeline-restructure.md 的交付。首次判决与步态问题见 evidence。开训协议闸门另归 work/active/eval-protocol-before-training.md。
