...
FIGURES = [
    ...
    ("progress", "Curriculum / success / velocity error",
     [("Curriculum/terrain_levels", "terrain_levels (v1-v10)"),
      ("Curriculum/joint_sir/frontier_max_v", "frontier_max_v (v11, m/s)"),
      ("Curriculum/joint_sir/tr_mean", "joint SIR Tr mean"),
      ("Curriculum/joint_sir/particle_entropy", "particle entropy"),
