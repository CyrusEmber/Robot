# v10 支撑诊断 summary（2026-09-21 15:36:49）
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| p1a_zero_action_5s | 1.7 | None | 0.039 | 1.0153 | -0.15 | 0.0158 | base_link=0.0N(z=0.94,mesh=nan),chest_yaw=0.0N(z=0.94,mesh=None),tail1_yaw=0.0N(z=0.91,mesh=None) | 0.0 | 3.8/0 | 0.056 | 0.04 | [0.073, 0.072, 0.071, 0.074] | [0.213, 0.259, 0.315, 0.228] | rr_foot,rl_foot,rf_foot,lf_foot | False |
| p1b_policy_still_10s | 26.7 | None | 4.509 | 0.968 | 0.314 | 0.1084 | neck_pitch=90.29N(z=0.281,mesh=-0.005),base_link=0.0N(z=1.041,mesh=nan),chest_yaw=0.0N(z=1.041,mesh=None) | 0.0 | 1.8/0 | 1.0 | 0.1 | [0.188, 0.078, 0.104, 0.2] | [0.0, 0.054, 0.459, 0.328] | rr_foot,rl_foot,rf_foot,lf_foot | False |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| p2_flat_v0.5_r0 | 0.5 | 0.468 | -0.064 | 0.064 | 0.055 | 0.075 | 0.45 | -0.008 | 0.036 | 4.63 | 0.16 | -6.6° | 0.468 | 26.2 | 0.292 | [0.002, 0.372, 0.744, 0.682] | [0.002, 0.071, 0.425, 0.31] | 0.9241 | neck_pitch=82.18N(mesh=-0.005),base_link=0.0N(mesh=nan),chest_yaw=0.0N(mesh=None) | 0.476 | 0.0 | {"5": 1.455, "6": 0.0} |
| p2_flat_v0.5_r1 | 0.5 | 0.468 | -0.063 | 0.063 | 0.052 | 0.072 | 0.451 | -0.01 | 0.036 | 4.65 | 0.14 | -6.8° | 0.468 | 26.2 | 0.288 | [0.002, 0.354, 0.742, 0.698] | [0.0, 0.066, 0.434, 0.305] | 0.929 | neck_pitch=87.39N(mesh=-0.005),base_link=0.0N(mesh=nan),chest_yaw=0.0N(mesh=None) | 0.482 | 0.0 | {"5": 1.458, "6": 0.0} |
| p2_flat_v0.5_r2 | 0.5 | 0.467 | -0.067 | 0.067 | 0.063 | 0.086 | 0.448 | -0.012 | 0.038 | 4.63 | 0.18 | -7.1° | 0.466 | 26.3 | 0.3 | [0.002, 0.312, 0.742, 0.698] | [0.001, 0.061, 0.465, 0.319] | 0.9789 | neck_pitch=94.2N(mesh=-0.005),base_link=0.0N(mesh=nan),chest_yaw=0.0N(mesh=None) | 0.486 | 0.0 | {"5": 1.443, "6": 0.0} |
