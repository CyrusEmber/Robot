...
> 本文余下内容为取消前的方案与评审历史，旧框架并行前置门及开训选项不再执行。已发生的共享语义变更与行 SIR 缺陷另有落点，见 `acceptance/records/2026-09-22-lizard-family-retirement.md`；取消不代表机制已经验证。

> 生成：2026-09-16。状态：**已取消（2026-09-22，家族因机体设计缺陷退役；未冻结、未实施）**。
